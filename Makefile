...
# PKG_CONFIG_DEPENDS был удален, так как minisign теперь обязательный
...
define Package/$(PKG_NAME)
	...
	PKGARCH:=all
	# Обязательная зависимость от dnscrypt-proxy2 и minisign
	DEPENDS:=+dnscrypt-proxy2 +luci-compat +luci-lib-ip +minisign
endef
